    ...
    */    
	public function index()
	{
	 ...
	 $this->Data_['menu_lateral'] = array( 	 	
	 	...
	 	' <li><a href="' . base_url() . 'index.php/contactos">' . 'Contactos' .'</a> </li>',
